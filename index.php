	...
	<div id = "pagina_inhoud_home">
		<div class="artikel">
			<p>
                ...
                <strong>Linda de Mol wil graag nog een nieuwe film maken. ''Ik ben bezig met een film in mijn hoofd en op papier. Die wil ik graag maken.'' Dat zei de presentatrice zondagmiddag tijdens een uur durend interview op het LINDA.festival in Zaandam.</strong>
                <br /><br />
		...
		<div class="artikel">
			<p>
                ...
                <strong>Charlie Sheen heeft een nieuwe vriendin. En Julia Stambler is niet bang dat ze ook hiv krijgt. Dat de 51-jarige acteur het gevaarlijke virus heeft, schrikt haar totaal niet af.</strong>
                <br /><br />
                Bronnen dichtbij het stel vertellen aan TMZ dat Charlie en Julia ervan overtuigd zijn dat zij geen hiv zal krijgen door anti-virale medicatie en voorbehoedsmiddelen. Bovendien zegt Sheen dat zijn 'hiv-levels onzichtbaar' zijn, wat Julia alleen meer geruststelt.
                <br />
        ...
        <div class="artikel">
            <p>
                ...
                <strong>George en Amal Clooney schroeven hun beveiliging behoorlijk op nu hun tweeling is geboren. Volgens Daily Star krijgen baby's Ella en Alexander hun eigen bodyguards.</strong>
                <br /><br />
		...
		<div class="artikel">
			<p>
                ...
                <strong>Katy Perry barstte dit weekend in tranen uit tijdens een therapeutische sessie die live te zien was op haar Youtube-kanaal. Huilend en met uitgelopen mascara vertelde de zangeres over haar depressies.</strong>
                <br /><br />
                De 32-jarige popprinses heeft camera's opgehangen in haar huis en zendt het hele weekend live uit ter promotie van haar nieuwe album Witness. Zo ook haar sessie met Dr. Siri Sat Nam Singh. Aan hem klapte ze tijdens een emotioneel gesprek uit de school over haar wens om authentiek te zijn. Zo zou ze zich vaak verdeeld voelen tussen 'Katy Perry de popster' en Katheryn Hudson, de 'nerd' die haar familie en goede vrienden kennen.
                <br />
                Als ze begint over haar nieuwe korte kapsel krijgt ze het te kwaad. "Als Katy Perry ben ik sterk, maar als Katheryn Hudson ben ik dat niet. Mensen praten bijvoorbeeld over mijn haar, dat ze het niks vinden. Dat ze wilden dat het langer was. Maar ik wil zo vreselijk graag Katheryn Hudson zijn dat ik niet meer op Katy Perry wil lijken. En daarom heb ik mijn haar geknipt, omdat ik mijn authentieke zelf wil zijn."
                <br />
                <h4>Zelfmoord</h4>
                ...
                <br />
                De livestream duurt tot maandag en wordt afgesloten met een concert.
                <br /><br /><br />
			</p>
		</div>
        <div class="artikel">
            <p>
                ...
                <strong>Wie wint zondag de finale van het tweede seizoen van de duettenstrijd It Takes 2 en wordt de opvolger van Jan Versteegh? Tooske Ragas, Bibi Breijman, Ruben Nicolai en Buddy Vedder openen de show zondagavond met Alvaro Soler. De Spanjaard zingt zijn nieuwe single Animal en samen met finalisten zijn wereldhit Sofia.</strong>
                <br /><br />
                Verder zingen Buddy Vedder, Ruben Nicolai, Tooske Ragas en Bibi Breijman elk een duet met hun prof en een duet met een gastartiest. De gastartiesten in de finale-aflevering zijn: Xander de Buisonjé, Edsilia Rombley, Elske DeWall en Martin Buitenhuis. Twee BN'ers vallen halverwege de show af en twee gaan er door naar de eindronde.
                <br />
